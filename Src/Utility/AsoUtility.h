...
public:
	...
	// ベジェ曲線
	static Vector3 Bezier(const Vector3& p1, const Vector3& p2, const Vector3& p3, float t);
	...
	static int SqrMagnitude(const Vector3& v);
	...
	// 正規化
	static VECTOR Normalize(const Vector3& v);
	static VECTOR NormalizeV(const VECTOR& v);
