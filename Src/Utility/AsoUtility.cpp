...
Vector3 AsoUtility::Bezier(const Vector3& p1, const Vector3& p2, const Vector3& p3, float t)
{
    Vector3 a = Lerp(p1, p2, t);
    Vector3 b = Lerp(p2, p3, t);
    return Lerp(a, b, t);
}
...
double AsoUtility::Magnitude(const Vector3& v)
{
...
int AsoUtility::SqrMagnitude(const Vector3& v)
{
...
double AsoUtility::Distance(const Vector3& v1, const Vector3& v2)
{
...
VECTOR AsoUtility::Normalize(const Vector3& v)
{
    VECTOR ret = VGet(
...
VECTOR AsoUtility::NormalizeV(const VECTOR& v)
{
...
{
    auto nDir = AsoUtility::NormalizeV(dir);
